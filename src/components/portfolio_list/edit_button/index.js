...
class EditButton extends Component {
  ...
  render() {
    const portfolio_list_edit_button = (() => {
      if (this.state.addable) {
        const currency_symbols = this.props.currencySymbols.map((symbol, i) => {
        ...
        return (
          <Row>
            ...
            <Button
              ...
              outline
              color="success"
              onClick={this.addCurrencyToPortfolio}
            >
              ✓
            </Button>
            <Button
        ...
        return (
          <Row>
            <Button outline color="info" onClick={this.props.editList} block>
              Done
            </Button>
          </Row>
        );
