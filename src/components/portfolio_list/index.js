...
class PortfolioList extends Component {
  ...
  render() {
    const portfolio_holdings = this.renderPortfolio();
    ...
    if (this.props.total === 0) {
      return (
        <div className="portfolio-list">
          ...
          <Row className="portfolio-holdings">{portfolio_holdings}</Row>
          <Row>
            <EditButton
              addHolding={this.props.addHolding}
              editList={this.props.editList}
    ...
    const portfolio_total = `$${this.props.total.toFixed(2)}`;
    return (
      <div className="portfolio-list">
        <Row className="portfolio-total">
          <Col>{portfolio_total}</Col>
        </Row>
        <Row className="portfolio-holdings">{portfolio_holdings}</Row>
        <Row>
          <EditButton
