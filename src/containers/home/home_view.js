        ...
        <Row>
          <Col>
            <Jumbotron>
              ...
              <p className="lead">
                <b>chalupa.io</b> is a tool to help you track your portfolio,
                share your gains, and reap the rewards.
              </p>
              <hr className="my-2" />
              <p>
                We are currently in beta but are adding new features on a
                regular basis.
              </p>
              <p>
                The current <em>optimistic</em> goal is to add FREE tax
                calculations before the end of the 2017 tax season.
              </p>
              <p className="lead">
                <Button tag={Link} to="/features" color="primary">
                  Learn More
                </Button>
              </p>
            </Jumbotron>
          ...
          <Col>
            <div className="intro-text">
              ...
              {this.props.auth.isAuthenticated ? (
                <p>
                  *Changes to your portfolio (while logged in) will be saved to
                  your account.
                </p>
              ) : (
                <p>
                  *Sign up to save your portfolio and get access to more
        ...
        <Row>
          ...
          <Col xs="12" lg="7">
            <div className="portfolio-pie">
              <PieChart list={this.props.list} />
            </div>
          </Col>
        </Row>
        <Row>
          <SortableTable list={this.props.list} />
        </Row>
        <Row>
